...
public:
    // Constructor (αν χρειάζεται να κρατάει αναφορές)
    EnvironmentManager() {}

    // Public μέθοδοι (Αυτές που καλείς από το main.cpp)
...
private:
    // Private βοηθητικές μέθοδοι (Εδώ μπαίνουν αυτά που είχες σε comment)
    ...
    void printTemperatureStats(DHT_Sensor &dht, EEPROM_25LC040A &eeprom, TemperatureDailyStats &td, TemperatureLifetimeStats &tl);
    void printHumidityStats(DHT_Sensor &dht, EEPROM_25LC040A &eeprom, HumidityDailyStats &hd, HumidityLifetimeStats &hl);
};